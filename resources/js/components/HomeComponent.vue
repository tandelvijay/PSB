    ...
    <div class="container">
        <div>
            ...
            <div class="client-list mt-3">
                <div class="row">
                    <div class="col-md-4" v-for="client, key in clientList">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <span class="links" style="position: absolute; top: 27px;right: 15px;color: #aec1cb;text-shadow: 0px 1px 0px white;font-family: 'AvenirLT-Medium';text-transform: uppercase;font-size: 1em;">
                                      ...
                                      <a href="#" data-action="deleteClient" title="Delete this briefcase and all of its presentations" @click="deleteClient(client.id)">Delete</a>
                                </span>
                                <hr>
                                ...
                                <!--<small class="left" style="float: left;-->
    <!--padding-left: 15px;">-->
